...
def get_agent_pipeline() -> Pipeline:
    repo = "mathislucka/deepset-webinar-ui"
    view_repo_tool = ComponentTool(
        component=GithubContentViewer(repo=repo, raise_on_failure=False),
    ...
    file_editor_tool = ComponentTool(
        component=GithubFileEditor(repo=repo, raise_on_failure=False),
        name="file_editor",
